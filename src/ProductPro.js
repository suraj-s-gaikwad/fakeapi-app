...
export default function ProductPro() {
   ...
   <div className="card-body">
     ...
     <NavLink to={`/productpro/${product.id}`} className="btn btn-outline-dark">Buy Now</NavLink>
   </div>
 </div>   
                             </div>
                      </>
    ...
    <div>
        <div className="container my-5 py-5">
            ...
            <div className='row justify-content-center'>
                {loading ? <Loading/> : <ShowProductPro/>}
            </div>
        </div>
        <Footer/>
    </div>
